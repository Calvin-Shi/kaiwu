...
ckpt_dir=`grep '^restore_dir' kaiwudrl/conf/kaiwudrl/configure.toml | cut -d '=' -f2 | tr -d ' '`
app=`grep '^app' kaiwudrl/conf/kaiwudrl/configure.toml | cut -d '=' -f2 | tr -d ' '`
algo=`grep '^algo' kaiwudrl/conf/kaiwudrl/learner.toml | cut -d '=' -f2 | tr -d ' '`
