...
if [ $# -ne 2 ];
then
    echo -e "\033[31m useage: sh kaiwudrl/utils/change_set_name_and_uuid.sh set_name uuid, sh kaiwudrl/utils/change_set_name_and_uuid.sh set10 uuid10  \033[0m"
