...
import datetime
import schedule
from common_python.ipc.zmq_util import ZmqServer, ZmqConfig, ZmqPoller
...
class ActorServerSync(Worker):
    ...
    def __init__(self) -> None:
        ...
        self.zmq_server = ZmqServer(CONFIG.ip_address, CONFIG.zmq_server_port, zmq_config)
    ...
    def get_from_to_predict_queue(self):
        ...
        if CONFIG.algorithm_on_policy_or_off_policy == KaiwuDRLDefine.ALGORITHM_ON_POLICY:
            ...
            try:
                return self.predict_request_queue.get(timeout=CONFIG.queue_wait_timeout)
            except Exception as e:
                return None
        ...
        while not self.exit_flag.value:
            try:
                ...
                self.logger.exception(
                    f"actor_server ActorServer run error: {str(e)}",
                    g_not_server_label,
                )
