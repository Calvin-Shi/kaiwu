...
gpu_configure_file=kaiwudrl/thirdparty/model_pool_go/config/gpu.iplist
openmpi_congiure_file=kaiwudrl/utils/run_mulit_learner_by_openmpirun.sh
...
produce_config_by_process_name()
{
    ...
    then
        ...
        then
            ...
            # 配置kaiwudrl/thirdparty/model_pool_go/config下面的gpu.iplist
    ...
    then
        ...
        # 配置kaiwudrl/utils下的run_mulit_learner_by_openmpirun.sh里的Nodelist和Num_process
